...
This is expected, and the steps below are the ones Apple intends you to use.
...
The warning means only that Apple has not been paid to check the app. It is not
a finding about the app. If that trade-off does not suit you, the source is
available and you can build it yourself in Xcode.
