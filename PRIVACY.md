...
- It has **no internet permission**, so it cannot transmit anything, anywhere.
  (The F-Droid build's support link, when one is configured, opens your
  browser; the app itself still makes no network connection. See below.)
...
There are four ways, and all four are things you choose to do.
...
**The support link (F-Droid build only).** The Info panel of the F-Droid build
can carry a PayPal payment link. Tapping it hands a URL to
your browser and PayPal's site opens there — the app does not fetch it, and
this does not give the app network access: it still holds no internet
permission. No dive data, and nothing identifying you or your installation, is
included in that URL or passed to PayPal by the app. Anything that happens once
your browser is on PayPal's site is between you and PayPal, under their privacy
policy. If you never tap it, nothing leaves the device. The Google Play build
does not show this link at all.
